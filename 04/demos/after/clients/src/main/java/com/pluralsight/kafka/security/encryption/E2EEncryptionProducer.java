...
public class E2EEncryptionProducer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put("crypto.rsa.publickey.filepath", "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/04/demos/after/security/public.key");

        props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, "SSL");
        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/04/demos/after/security/keystore/producer.keystore.jks");
        props.put(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG, "password");
        props.put(SslConfigs.SSL_KEY_PASSWORD_CONFIG, "password");
        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/04/demos/after/security/truststore/producer.truststore.jks");
