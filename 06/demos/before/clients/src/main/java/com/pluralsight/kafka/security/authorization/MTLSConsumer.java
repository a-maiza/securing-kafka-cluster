...
public class MTLSConsumer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, "/Users/bogdan/pluralsight/securing-kafka-cluster/m6/security/keystore/consumer.keystore.jks"); // Replace with the absolute path on your machine
        props.put(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG, "password");
        props.put(SslConfigs.SSL_KEY_PASSWORD_CONFIG, "password");

        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "/Users/bogdan/pluralsight/securing-kafka-cluster/m6/security/truststore/consumer.truststore.jks"); // Replace with the absolute path on your machine
        ...
        consumer.subscribe(Collections.singletonList("auth-topic"));
