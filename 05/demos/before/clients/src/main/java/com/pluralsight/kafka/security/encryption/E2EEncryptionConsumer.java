...
public class E2EEncryptionConsumer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put("crypto.rsa.privatekey.filepath", "/Users/bogdan/pluralsight/securing-kafka-cluster/m4/security/private.key"); // Replace with the absolute path on your machine
