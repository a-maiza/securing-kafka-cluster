...
public class E2EEncryptionConsumer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put("crypto.rsa.privatekey.filepath", "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/05/demos/befor/security/private.key"); // Replace with the absolute path on your machine
