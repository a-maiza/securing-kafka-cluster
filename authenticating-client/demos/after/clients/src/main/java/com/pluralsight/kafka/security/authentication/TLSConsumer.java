...
public class TLSConsumer {
    ...
    private static final Logger log = LoggerFactory.getLogger(TLSConsumer.class);
...
//        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/authenticating-client/demos/after/security/keystore/consumer.keystore.jks");
//        props.put(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG, "password");
//        props.put(SslConfigs.SSL_KEY_PASSWORD_CONFIG, "password");

        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/authenticating-client/demos/after/security/truststore/consumer.truststore.jks");
