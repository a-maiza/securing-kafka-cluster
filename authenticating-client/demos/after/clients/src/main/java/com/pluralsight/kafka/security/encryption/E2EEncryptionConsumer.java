...
public class E2EEncryptionConsumer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put("crypto.rsa.privatekey.filepath", "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/authenticating-client/security/private.key"); // Replace with the absolute path on your machine

        props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, "SSL");

        props.put(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/authenticating-client/demos/after/security/keystore/consumer.keystore.jks"); // Replace with the absolute path on your machine
        props.put(SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG, "password");
        props.put(SslConfigs.SSL_KEY_PASSWORD_CONFIG, "password");

        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "/Users/abdeldjalilmaiza/IdeaProjects/securing-kafka-cluster/authenticating-client/demos/after/security/truststore/consumer.truststore.jks"); // Replace with the absolute path on your machine
